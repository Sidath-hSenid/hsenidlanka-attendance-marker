class SizeConstants {
  ...
  static const double textFieldPaddingHorizontal = 15.0;
  static const double textFieldPaddingTop = 10.0;
  static const double textFieldPaddingBottom = 10.0;
  static const double textFieldWithAppBarPaddingTop = 20;

  // Button
  static const double buttonFontSize = 20.0;
  static const double buttonBorderRadius = 25.0;
  static const double buttonEnabledBorderWidth = 2.0;
  static const double buttonPaddingHorizontal = 15.0;
  static const double buttonPaddingTop = 20.0;
  static const double buttonPaddingBottom = 10.0;
  static const double buttonHeight = 15;

  // Toast
  static const double toastFontSize = 16.0;

  // Link
  static const double forgotPasswordLinkFontSize = 14.0;
  static const double rightSideTextPaddingRight = 15.0;
  static const double rightSideTextPaddingTop = 5.0;
  static const double rightSideTextPaddingBottom = 5.0;
  static const double validateOTPLinkFontSize = 14.0;

  // Title
  static const double titleTextFontSize = 30.0;
  static const double titleTextPaddingHorizontal = 15.0;
  static const double titleTextPaddingTop = 60.0;
  ...
  static const double signIgnImagePaddingLeft = 30.0;
